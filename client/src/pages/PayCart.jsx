    ...
    <div className="bg-bg_gray h-screen px-5">
      ...
      <div className="flex mt-5 justify-between">
        <div className="shadow-xl">
          <img className="w-[320px]" src={paymethod} alt="" />
        </div>
        <div className="bg-white p-5 mr-5 rounded-md shadow-xl">
          <div>
            <h2
        ...
        <div className="mt-[0px] shadow-xl flex flex-col w-[300px] justify-center items-center py-5 rounded-md bg-white">
